...
_CSV_PATH = "/home/sandbox/Work/mujoco_playground/learning/notebooks/logs/HunterJoystick-20251014-121914"
...
command = jp.array([1.0, 0.0, 0.0])  # Initial command
gait_freq = 1.5 
foot_height = 0.1
...
for j in range(episode): 
    ...
    if gait == 1:
       folder_name = f"/home/sandbox/Work/mujoco_playground/learning/notebooks/videos/{name}-gait-{gait}"
       file_name = f"/home/sandbox/Work/mujoco_playground/learning/notebooks/videos/{name}-gait-{gait}/seed{j}.mp4"
    else:
       folder_name = f"/home/sandbox/Work/mujoco_playground/learning/notebooks/videos/{name}-gait-{gait}-gait-freq-{gait_freq}-foot-height-{foot_height}"
       file_name = f"/home/sandbox/Work/mujoco_playground/learning/notebooks/videos/{name}-gait-{gait}-gait-freq-{gait_freq}-foot-height-{foot_height}/seed{j}.mp4"
